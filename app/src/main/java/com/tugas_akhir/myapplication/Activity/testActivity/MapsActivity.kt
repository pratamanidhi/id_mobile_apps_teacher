...
//        LatLng(52.524198, 13.368333),
    ...
    private fun getListener(): AnimatorListenerAdapter1 {
        return object : AnimatorListenerAdapter1() {
    ...
    private fun getPolylineOptions(): PolylineOptions {
        return PolylineOptions()
            .color(ContextCompat.getColor(this, R.color.design_default_color_primary_variant))
            .pattern(
                listOf(
                    Dot(), Gap(20F)
                )
